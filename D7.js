...
*/
const letters = ["EPICODE", "is", "great"];
function numLetters(array) {
  return array.map((i) => i.length);
}

console.log(numLetters(letters));
...
const oldestMovie1 = function (array) {
...
console.log(oldestMovie1(movies));
...
//console.log(oldestMovie2(movies));
...
*/
function filmNames(array) {
  return array.map((movie) => i.Title);
}
...
*/
function millenial(array) {
  return array.filter((movie) => parseInt(i.Year) > 1999);
}
